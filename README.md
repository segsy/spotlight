...
Recursive extraction of posts + nested comments

User profile metadata

Flexible sort filters (e.g., hot, new, top, rising)

Time range filters

Proxy support + pagination for large, reliable crawls

Output suited for sentiment analysis workflows and downstream NLP processing